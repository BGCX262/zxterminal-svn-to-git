...
void Java_com_feihong_newzxclient_util_RecordUtils_initEncoder(JNIEnv *env,
...
void Java_com_feihong_newzxclient_util_RecordUtils_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_com_feihong_newzxclient_util_RecordUtils_encodeFile(JNIEnv *env,
