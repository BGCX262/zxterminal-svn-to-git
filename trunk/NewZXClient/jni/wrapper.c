...
void Java_com_zaoxuntec_zxclient_MainActivity_initEncoder(JNIEnv *env,
...
void Java_com_zaoxuntec_zxclient_MainActivity_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_com_zaoxuntec_zxclient_MainActivity_encodeFile(JNIEnv *env,
