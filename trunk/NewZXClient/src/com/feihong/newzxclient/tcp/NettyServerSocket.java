...
import com.feihong.newzxclient.util.PrintUtils;
...
public class NettyServerSocket {
    ...
    public NettyServerSocket() throws IOException{
        ...
        public void run(){
            try {
                ...
                while(true) {
                    ...
                    os.write(NumUtils.intToBytes(5));
                    String str = "Hello";
                    os.write(str.getBytes());
                    System.out.println(PrintUtils.printBytes(str.getBytes()));
                    os.flush();
