...
{
public:
	CPackBody(unsigned char btType,unsigned char* pData,unsigned long ulLen)
	{
		if (ulLen != 0)
		{
...
public:
	...
	CPacket(unsigned char btType,unsigned char btCompress,unsigned char* pData, unsigned long ulLen):m_Head(btType,btCompress,ulLen),
